<?php
    require_once('maidserver.php');
    check_login();

    if(isset($_POST['deny_booking'])) {
        $booking_id = $_POST['booking_id'];
        deny_booking($booking_id);
...
<div class="box form-box">
    ...
    <form method="post">
        <p>Are you sure you want to deny this booking?</p>
        <input type="hidden" name="booking_id" value="<?php echo $_GET['booking_id']; ?>">
        <button type="submit" name="deny_booking" class="yesdelete">Yes, deny</button>
        <a href="profilehome.php" class="nodelete">No, cancel</a>
    </form>
</body>
</html>
