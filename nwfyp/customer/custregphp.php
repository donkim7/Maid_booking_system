...
<div style="color: brown;" >
    ...
    <div class="field input">
        ...
        <input type="text" name="c_firstname" id="firstname" autocomplete="off" required>
    </div>
    <div class="field input">
    ...
    <!-- <div class="field input">
        <label for="img">Upload passport size picture: </label>
        <input type="file" name="img" id="img" accept="image/*" autocomplete="off" required>
    </div> -->
    <div class="field ">
        <input class="btn" type="submit" name="submit" value="Signup" required>
        <!-- <button class="btn" type="submit"name="submit">Register</button> -->
    </div>
    <div class="links">
        Already a member?<a href="custlogphp.php"> Login here</a>
    </div>
