...
<div class="box form-box">
    ...
    <form method="post">
        <p>Are you sure you want to delete this maid?</p>
        <input type="hidden" name="maid_id" value="<?php echo $_GET['maid_id']; ?>">
        <button type="submit" name="delete_maid" class="yesdelete">Yes, delete</button>
        <a href="maidsadmin.php" class="nodelete">No, cancel</a>
    </form>
</body>
</html>
