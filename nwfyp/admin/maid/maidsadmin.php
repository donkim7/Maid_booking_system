...
<div class="sidebar">
  ...
  <a class="active" href="#news">Maids</a>
...
<table>
  ...
  <tbody>
    ...
    foreach ($maids as $maid) {
      ...
      echo "<td>";
      echo "<a href='editmaid.php?maid_id=" . $maid->maid_id . "' class='edit-button'>Edit</a> ";
      echo "<a href='deletemaid.php?maid_id=" . $maid->maid_id . "' onclick='return confirm(\"Are you sure you want to delete this maid?\")' class='delete-button'>Delete</a>";
      echo "</td>";
      echo "</tr>";
    }
