...
<h2>Maids Dashboard</h2>
  ...
  <tbody>
    ...
    foreach ($maids as $maid) {
      echo "<tr>";
      echo "<td>" . $maid->maid_id . "</td>";
      echo "<td>" . $maid->m_firstname . "</td>";
      echo "<td>" . $maid->lastname . "</td>";
      echo "<td>" . $maid->address . "</td>";
      echo "<td>" . $maid->email . "</td>";
      echo "<td>" . $maid->phone_number . "</td>";
      echo "<td>" . $maid->gender . "</td>";
      echo "<td><img src='../maid/img/" . $maid->image . "' width='150' height='120' alt='Passport Image'></td>";
      echo "<td>";
      echo "<a href='maid/editmaid.php?maid_id=" . $maid->maid_id . "' class='edit-button'>Edit</a> ";
      echo "<a href='maid/deletemaid.php?maid_id=" . $maid->maid_id . "' onclick='return confirm(\"Are you sure you want to delete this maid?\")' class='delete-button'>Delete</a>";
      echo "</td>";
      echo "</tr>";
    }
  ...
  <tbody>
    ...
    foreach ($customers as $customer) {
      ...
      echo "<td>" . $customer->c_firstname . "</td>";
      echo "<td>" . $customer->lastname . "</td>";
      echo "<td>" . $customer->address . "</td>";
      echo "<td>" . $customer->email . "</td>";
      echo "<td>" . $customer->phone_number . "</td>";
      echo "<td>" . $customer->gender . "</td>";
    //   echo "<td>" . $customer->image . "</td>";
      echo "<td>";
      echo "<a href='customer/editcustomer.php?customer_id=" . $customer->customer_id . "' class='edit-button'>Edit</a> ";
      echo "<a href='customer/deletecustomer.php?customer_id=" . $customer->customer_id . "' onclick='return confirm(\"Are you sure you want to delete this customer?\")' class='delete-button'>Delete</a>";
      echo "</td>";
      echo "</tr>";
    }
