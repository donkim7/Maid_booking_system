...
<h1>Customers Dashboard</h1>
  ...
  <tbody>
    ...
    //   echo "<td>" . $customer->image . "</td>";
      echo "<td>";
      echo "<a href='editcustomer.php?customer_id=" . $customer->customer_id . "' class='edit-button' >  Edit</a> ";
      echo "<a href='deletecustomer.php?customer_id=" . $customer->customer_id . "' onclick='return confirm(\"Are you sure you want to delete this customer?\")' class='delete-button' >Delete</a>";
      echo "</td>";
      echo "</tr>";
    }
